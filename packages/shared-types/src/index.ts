...
// Single source of truth for types shared across the entire monorepo:
// - apps/api  (Express backend)
// - apps/web  (Next.js frontend)
// - apps/ussd (Africa's Talking USSD module)
...
// USSD-specific farmer/listing types (maps to Supabase tables in apps/ussd)
...
// ── Frontend-specific domain types (regional bidding) ─────────────────
